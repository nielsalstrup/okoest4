...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class=" bd-comment-5 <?php echo $comment->comment_type ?>">
        <div class=" bd-layoutcontainer-24 bd-columns
...
<div class=" bd-comments-5" id="comments">
    ...
    if (!function_exists('theme_comment_form_defaults_filter_5')){
        function theme_comment_form_defaults_filter_5($defaults) {
            ...
            $defaults['comment_notes_after'] = '<p class="form-allowed-tags">'
                . sprintf('<label class=" bd-bootstraplabel">' . __('<strong>XHTML:</strong> You can use these tags: <code>%s</code>') . '</label>', allowed_tags())
                . '</p>';
            return $defaults;
        }
    ...
    echo str_replace(
        ...
        array(
            ...
            '</h2></div>',
            'type="text"  class=" bd-bootstrapinput form-control input-sm"',
            '<textarea  class=" bd-bootstrapinput form-control input-sm"',
