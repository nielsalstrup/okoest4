...
<h2 itemprop="name" class=" bd-productoverviewtitle-1"><?php echo $product_view['title']; ?></h2>
<?php endif; ?>
...
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class=" bd-pricetext-15">',
            'old_price_end' => '</div>',
            'old_price_label' => ' bd-label-17',
            'old_price_label_attributes' => '',
            'old_price_amount' => ' bd-container-36 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class=" bd-pricetext-14">',
            'regular_price_end' => '</div>',
            'regular_price_label' => false,
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => ' bd-container-35 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
