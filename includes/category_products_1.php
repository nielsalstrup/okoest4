...
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class=" bd-pricetext-11">',
            'old_price_end' => '</div>',
            'old_price_label' => ' bd-label-11',
            'old_price_label_attributes' => '',
            'old_price_amount' => ' bd-container-30 bd-tagstyles',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class=" bd-pricetext-10">',
            'regular_price_end' => '</div>',
            'regular_price_label' => ' bd-label-10',
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => ' bd-container-29 bd-tagstyles',
...
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class=" bd-pricetext-13">',
            'old_price_end' => '</div>',
            'old_price_label' => ' bd-label-13',
            'old_price_label_attributes' => '',
            'old_price_amount' => ' bd-container-32 bd-tagstyles',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class=" bd-pricetext-12">',
            'regular_price_end' => '</div>',
            'regular_price_label' => ' bd-label-12',
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => ' bd-container-31 bd-tagstyles',
            'regular_price_amount_attributes' => '',
        )); ?>
    </span>
<?php
