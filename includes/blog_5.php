...
?>
    ...
    <span class=" bd-icon bd-icon-42"><span><?php echo get_the_date(); ?></span></span>
</div>
...
<div class=" bd-postcontent-10 bd-tagstyles bd-custom-blockquotes">
    ...
    <div class="bd-container-inner">
        <div class=" bd-posticoncategory-26">
    <?php
        $categories = get_the_category_list(', ');
        if (theme_strlen($categories) > 0) : ?>
    <span class=" bd-icon bd-icon-55"><span><?php echo get_the_category_list(', ');?></span></span>
    <?php endif ?>
</div>
	
		<div class=" bd-posticontags-28">
    <?php $tags_list = get_the_tag_list('', ', '); ?>
    <?php if ($tags_list): ?>
    <span class=" bd-icon bd-icon-57"><span><?php echo $tags_list; ?></span></span>
    <?php endif; ?>
</div>
