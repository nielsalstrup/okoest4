...
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class=" bd-pricetext-6">',
            'old_price_end' => '</div>',
            'old_price_label' => false,
            'old_price_label_attributes' => '',
            'old_price_amount' => ' bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class=" bd-pricetext-5">',
            'regular_price_end' => '</div>',
            'regular_price_label' => false,
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => ' bd-container-13 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
...
?>
		...
		<?php theme_product_buy(' bd-productbuy-1 bd-button', ' '); ?>
