...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
    ...
    <div class="data-control-id-1200 bd-comment-1 <?php echo $comment->comment_type ?>">
        <div class="data-control-id-1086 bd-layoutcontainer-15 bd-columns
...
<div class="data-control-id-1239 bd-comments-1" id="comments">
    ...
    if (!function_exists('theme_comment_form_defaults_filter_1')){
        function theme_comment_form_defaults_filter_1($defaults) {
            ...
            $defaults['comment_notes_after'] = '<p class="form-allowed-tags">'
                . sprintf('<label class="data-control-id-190269 bd-bootstraplabel">' . __('<strong>XHTML:</strong> You can use these tags: <code>%s</code>') . '</label>', allowed_tags())
                . '</p>';
            return $defaults;
        }
    ...
    echo str_replace(
        ...
        array(
            ...
            '</h2></div>',
            'type="text"  class="data-control-id-1233 bd-bootstrapinput form-control input-sm"',
            '<textarea  class="data-control-id-1233 bd-bootstrapinput form-control input-sm"',
