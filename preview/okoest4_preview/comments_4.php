...
<div class="data-control-id-1979 bd-comments-4" id="comments">
    ...
    echo str_replace(
        ...
        array(
            ...
            '</h2></div>',
            'type="text"  class="data-control-id-1973 bd-bootstrapinput form-control input-sm"',
            '<textarea  class="data-control-id-1973 bd-bootstrapinput form-control input-sm"',
