...
<form action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post" class="data-control-id-2848 bd-shoppingcarttable-1">
    ...
    <div class="table-responsive">
        <table class="data-control-id-2838 bd-table">
            ...
            <tfoot>
                <tr>
                    <td colspan="6">
                        <div class="data-control-id-44550 bd-container-53 bd-tagstyles bd-custom-button">
                            <input class="data-control-id-44543 bd-button-15" type="submit" name="update_cart" value="<?php _e('Update Cart', 'woocommerce'); ?>" />
                            <input class="data-control-id-44543 bd-button-15" type="submit" name="proceed" value="<?php _e('Proceed to Checkout', 'woocommerce'); ?>" />
                            <?php
                                ...
                                if ( get_option( 'woocommerce_enable_coupons' ) == 'yes' && get_option( 'woocommerce_enable_coupon_form_on_cart' ) == 'yes') { ?>
                                    <div class="form-inline form-responsive-dependent-float">
                                        ...
                                        <input class="data-control-id-44543 bd-button-15" type="submit" name="apply_coupon" value="<?php _e('Apply Coupon', 'woocommerce'); ?>"/>
                                    </div>
                    ...
                    if ($_product && $_product->exists() && $cart_item['quantity'] > 0) {
                        ...
                        <tr <?php if ($i % 2 === 0): ?>class="alt"<?php endif ?>>
                            ...
                            <td class="product-thumbnail">
                                <?php
                                    $thumbnail = apply_filters( 'woocommerce_in_cart_product_thumbnail', $_product->get_image('shop_thumbnail', array('class' => 'data-control-id-2825 bd-imagestyles')), $cart_item, $cart_item_key ); /**/ ?>
                            ...
                            <td class="product-name">
                                <div class="data-control-id-2846 bd-producttext-15">
    <?php
                            ...
                            <td class="product-quantity">
                                <?php
                                    if ( $_product->is_sold_individually() ) {
                                        ...
                                        $product_quantity = sprintf( '<div class="quantity"><input type="%s" name="cart[%s][qty]" data-min="%s" data-max="%s" value="%s" size="4" title="Qty" class="qty data-control-id-2847 bd-bootstrapinput form-control input-sm" maxlength="12" /></div>', theme_wc_quantity_buttons_supported() ? 'text' : 'number', $cart_item_key, $data_min, $data_max, esc_attr( $cart_item['quantity'] ));
                                    }
 ...
 bd-icon-69 bd-icon data-control-id-2845"></span></a>',
                                        $href,
