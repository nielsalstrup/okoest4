...
?>
        <?php
    ob_start();
    theme_print_sidebar('secondary', 'secondary_14_12');
    ...
    theme_print_sidebar_content($current_sidebar_content, 'secondary', 'data-control-id-1364801 bd-secondarywidgetarea-12 clearfix', '');
?>
 ...
 $theme_hide_sidebar_area ||
            ...
            <aside class="bd-sidebararea-1-column data-control-id-1364735 bd-flex-vertical bd-flex-fixed<?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
        ...
        <?php else: ?>
            <?php if ($area_content
 && !$theme_hide_sidebar_area): ?>
                <aside class="bd-sidebararea-1-column data-control-id-1364735 bd-flex-vertical bd-flex-fixed">
                    <div class="bd-sidebararea-1 bd-flex-wide">
