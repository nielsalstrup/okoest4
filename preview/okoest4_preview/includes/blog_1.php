...
<div class="data-control-id-234738 bd-postcontent-8 bd-tagstyles">
    ...
    <a class="bd-postreadmore-4 bd-button data-control-id-1002005"   title="<?php echo strip_tags('Continue reading...') ?>" href="<?php echo get_permalink($post->ID) ?>"><?php _e('Continue reading...'); ?></a>
<?php endif; ?>
    </div>
</div>
