...
?>
    ...
    <div class="bd-container-inner">
        <div class="data-control-id-2446 bd-layoutcontainer-27 bd-columns">
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row ">
 ...
 col-xs-8">
    ...
    <?php woocommerce_catalog_ordering(); ?>
		...
		<?php if ( isset($product_view['link']) && isset($product_view['title']) ){ ?><div class="data-control-id-2271 bd-producttitle-8"><a itemprop="name" href="<?php echo $product_view['link']; ?>"><?php echo $product_view['title']; ?></a></div><?php } ?>
...
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class="data-control-id-2342 bd-pricetext-11">',
            'old_price_end' => '</div>',
            'old_price_label' => 'data-control-id-2309 bd-label-11',
            'old_price_label_attributes' => '',
            'old_price_amount' => 'data-control-id-2341 bd-container-30 bd-tagstyles',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class="data-control-id-2308 bd-pricetext-10">',
            'regular_price_end' => '</div>',
            'regular_price_label' => 'data-control-id-2275 bd-label-10',
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => 'data-control-id-2307 bd-container-29 bd-tagstyles',
...
?>
                            ...
                            <div class="separated-item-5 col-md-12 list"<?php if ('list' !== $product_view['activeLayoutName']) { echo 'style="display:none;"';} ?>>
                                <div class="data-control-id-2486 bd-griditem-5">
                                    ...
                                    <div class="data-control-id-54401 bd-layoutcontainer-26 bd-columns">
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row ">
...
?></div></div>
 ...
 col-md-7">
    <div class="bd-layoutcolumn-58 bd-column" ><div class="bd-vertical-align-wrapper"><?php if ( isset($product_view['link']) && isset($product_view['title']) ){ ?><div class="data-control-id-2363 bd-producttitle-10"><a itemprop="name" href="<?php echo $product_view['link']; ?>"><?php echo $product_view['title']; ?></a></div><?php } ?>
...
<div class="data-control-id-2365 bd-productdesc-11">
 ...
 col-md-2">
    <div class="bd-layoutcolumn-59 bd-column" ><div class="bd-vertical-align-wrapper"><div class="data-control-id-2435 bd-productprice-4">
<?php
        if (isset($product_view['price'])) {
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class="data-control-id-2434 bd-pricetext-13">',
            'old_price_end' => '</div>',
            'old_price_label' => 'data-control-id-2401 bd-label-13',
            'old_price_label_attributes' => '',
            'old_price_amount' => 'data-control-id-2433 bd-container-32 bd-tagstyles',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class="data-control-id-2400 bd-pricetext-12">',
            'regular_price_end' => '</div>',
            'regular_price_label' => 'data-control-id-2367 bd-label-12',
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => 'data-control-id-2399 bd-container-31 bd-tagstyles',
            'regular_price_amount_attributes' => '',
        )); ?>
    </span>
<?php
