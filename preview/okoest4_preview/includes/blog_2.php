...
<div class="data-control-id-1523304 bd-postcontent-4 bd-tagstyles bd-custom-blockquotes">
    ...
    <?php comments_popup_link(
                '<span class="data-control-id-1523349 bd-icon bd-icon-43"><span>'.__('Leave a comment', THEME_NS).'</span></span>',
    '<span class="data-control-id-1523349 bd-icon bd-icon-43"><span>'.__('1 Comment', THEME_NS).'</span></span>',
    '<span class="data-control-id-1523349 bd-icon bd-icon-43"><span>'.__('% Comments', THEME_NS).'</span></span>'); ?>
    <?php endif ?>
</div>
	
		<?php if ($post && !is_singular() && !theme_is_empty_html('Continue reading...')): ?>
    <a class="bd-postreadmore-2 bd-button-7 data-control-id-1523365"   title="<?php echo strip_tags('Continue reading...') ?>" href="<?php echo get_permalink($post->ID) ?>"><?php _e('Continue reading...'); ?></a>
<?php endif; ?>
    </div>
</div>
</article>
