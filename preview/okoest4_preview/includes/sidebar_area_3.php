...
?>
    ...
    theme_print_sidebar_content($current_sidebar_content, 'Area-3', 'data-control-id-1428736 bd-sidebar-15 hidden-xs clearfix', '');
?>
 ...
 $theme_hide_sidebar_area ||
            ...
            <aside class="bd-sidebararea-3-column data-control-id-1428634 bd-flex-vertical bd-flex-fixed<?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
        ...
        <?php else: ?>
            <?php if ($area_content
 && !$theme_hide_sidebar_area): ?>
                <aside class="bd-sidebararea-3-column data-control-id-1428634 bd-flex-vertical bd-flex-fixed">
                    <div class="bd-sidebararea-3 bd-flex-wide">
