...
class Theme_WooCommerce_Widget_Product_Slider extends WP_Widget {
    ...
    function Theme_WooCommerce_Widget_Product_Slider() {
...
?>
		...
		<?php if ( isset($product_view['link']) && isset($product_view['title']) ){ ?><div class="data-control-id-207 bd-producttitle-4"><a itemprop="name" href="<?php echo $product_view['link']; ?>"><?php echo $product_view['title']; ?></a></div><?php } ?>
...
?>
    <span class="price"><?php
        echo theme_price_html(array(
            ...
            'old_price_start' => '<div class="data-control-id-276 bd-pricetext-6">',
            'old_price_end' => '</div>',
            'old_price_label' => false,
            'old_price_label_attributes' => '',
            'old_price_amount' => 'data-control-id-275 bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
            'old_price_amount_attributes' => '',

            'regular_price_start' => '<div class="data-control-id-242 bd-pricetext-5">',
            'regular_price_end' => '</div>',
            'regular_price_label' => false,
            'regular_price_label_attributes' =>'',
            'regular_price_amount' => 'data-control-id-241 bd-container-13 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
...
?>
		...
		<?php theme_product_buy('data-control-id-282 bd-productbuy-1 bd-button', ' '); ?>
...
add_action('widgets_init', 'themeWooWidgetsInit');
