...
<div class="data-control-id-235321 bd-postcontent-10 bd-tagstyles bd-custom-blockquotes">
    ...
    <?php comments_popup_link(
                '<span class="data-control-id-1524454 bd-icon bd-icon-60"><span>'.__('Leave a comment', THEME_NS).'</span></span>',
    '<span class="data-control-id-1524454 bd-icon bd-icon-60"><span>'.__('1 Comment', THEME_NS).'</span></span>',
    '<span class="data-control-id-1524454 bd-icon bd-icon-60"><span>'.__('% Comments', THEME_NS).'</span></span>'); ?>
    <?php endif ?>
</div>
	
		<?php if ($post && !is_singular() && !theme_is_empty_html('Læs mere...')): ?>
    <a class="bd-postreadmore-6 bd-button-19 data-control-id-1002435"   title="<?php echo strip_tags('Læs mere...') ?>" href="<?php echo get_permalink($post->ID) ?>"><?php _e('Læs mere...'); ?></a>
<?php endif; ?>
    </div>
</div>
</article>
