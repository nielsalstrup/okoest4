...
<div class="data-control-id-3241 bd-productreviews-1">
    ...
    echo str_replace(
        ...
        array(
            ...
            '</h2></div>',
            'type="text"  class="data-control-id-3218 bd-bootstrapinput form-control input-sm"',
            '<textarea id="comment_area_1"  class="data-control-id-3218 bd-bootstrapinput form-control input-sm"',
