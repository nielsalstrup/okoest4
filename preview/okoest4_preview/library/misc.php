...
function theme_compare_get_params($a, $b) {
    $ignored = array(
...
function theme_is_current_url($url) {
    $current_url = theme_get_current_url();
    $get_params = theme_get_params($url);
    $current_get_params = theme_get_params($current_url);

    // compare
    $parsed_url = parse_url($url);
    $parsed_current_url = parse_url($current_url);
    return theme_compare_get_params($get_params, $current_get_params) &&
        theme_get_array_value($parsed_url, 'path') == theme_get_array_value($parsed_current_url, 'path');
}
