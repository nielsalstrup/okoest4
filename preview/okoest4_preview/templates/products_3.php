...
<body <?php body_class('data-control-id-19 bootstrap bd-body-3 bd-pagebackground'); /*   */ ?>>
<div data-affix
     data-offset=""
 ...
 col-sm-6">
    <div class="bd-layoutcolumn-9 bd-column" ><div class="bd-vertical-align-wrapper"><?php theme_logo_2(); ?></div></div>
		...
		<div class="bd-contentlayout-3 bd-sheetstyles data-control-id-330">
    <div class="bd-container-inner">
 ...
 <?php theme_sidebar_area_5(); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-1118924 bd-layoutitemsbox-17 bd-flex-wide">
