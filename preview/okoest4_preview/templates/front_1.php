...
<body <?php body_class('data-control-id-13 bootstrap bd-body-1 bd-pagebackground'); /*   */ ?>>
<div data-affix
     data-offset=""
 ...
 col-sm-6">
    <div class="bd-layoutcolumn-9 bd-column" ><div class="bd-vertical-align-wrapper"><?php theme_logo_2(); ?></div></div>
		...
		<div class="bd-containereffect-1 container data-control-id-1395701"><?php
    ob_start();
    theme_print_sidebar('Area-1', '10_13');
    ...
    theme_print_sidebar_content($current_sidebar_content, 'Area-1', 'data-control-id-1395698 bd-sidebar-13 hidden-xs  clearfix', '');
?></div>
	
		<div class="bd-containereffect-2 container data-control-id-1364986">
<div class="data-control-id-1243536 bd-stretchtobottom-1 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-1">
<div class="bd-contentlayout-1   bd-sheetstyles data-control-id-306" >
    <div class="bd-container-inner">
 ...
 <?php theme_sidebar_area_2(); ?>
                    ...
                    <div class="data-control-id-1118898 bd-layoutitemsbox-15 bd-flex-wide">
    <div class="bd-contentlayout-11 bd-sheetstyles data-control-id-1510173" >
    <div class="bd-container-inner">

        

                    <div class="data-control-id-1510171 bd-layoutitemsbox-4 bd-flex-wide">
    <div class="data-control-id-1510175 bd-content-3">
    <div class="bd-container-inner">
