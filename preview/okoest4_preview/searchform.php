    ...
    <div class="bd-container-inner">
        <div class="bd-search-wrapper">
                ...
                <div class="bd-input-wrapper">
                    <input name="s" type="text" class="data-control-id-3506 bd-bootstrapinput-2 form-control" value="<?php echo esc_attr(get_search_query()); ?>" placeholder="<?php _e('Search'); ?>">
                </div>
                
                <div class="bd-button-wrapper">
                    <input type="submit" class="data-control-id-3505 bd-button" value="<?php _e('Search'); ?>">
                </div>
        </div>
    </div>
    <?php
