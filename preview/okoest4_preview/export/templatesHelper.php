...
class PageTemplatesHelper {
    ...
    function __construct() {
        ...
        if (theme_woocommerce_enabled()) {
            $this->excludes[] = (int)woocommerce_get_page_id('shop');
            $this->excludes[] = (int)woocommerce_get_page_id('cart');
            $this->excludes[] = (int)woocommerce_get_page_id('checkout');
            $this->excludes[] = (int)woocommerce_get_page_id('myaccount');
            $this->excludes[] = (int)woocommerce_get_page_id('edit_address');
            $this->excludes[] = (int)woocommerce_get_page_id('view_order');
            $this->excludes[] = (int)woocommerce_get_page_id('change_password');
            $this->excludes[] = (int)woocommerce_get_page_id('logout');
        }
    }
