...
<div data-affix
 ...
 col-sm-6">
    <div class="bd-layoutcolumn-9 bd-column" ><div class="bd-vertical-align-wrapper"><?php theme_logo_2(); ?></div></div>
		...
		<div class="bd-containereffect-1 container "><?php
    ob_start();
    ...
    theme_print_sidebar_content($current_sidebar_content, 'Area-1', ' bd-sidebar-13 hidden-xs  clearfix', '');
?></div>
...
<div class="bd-contentlayout-1   bd-sheetstyles " >
 ...
 <?php theme_sidebar_area_2(); ?>
    ...
    <div class="bd-contentlayout-11 bd-sheetstyles " >
    <div class="bd-container-inner">

        

                    <div class=" bd-layoutitemsbox-4 bd-flex-wide">
