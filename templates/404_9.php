...
<body <?php body_class(' bootstrap bd-body-9 bd-pagebackground'); /*   */ ?>>
<div data-affix
     data-offset=""
...
<div class="bd-contentlayout-9  bd-sheetstyles ">
 ...
 <?php theme_sidebar_area_5(); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class=" bd-layoutitemsbox-2 bd-flex-wide">
    <div class=" bd-text404-12 bd-tagstyles shape-only"><?php theme_404_content(); ?></div>
</div>
