...
<?php
    if ('page' == get_option('show_on_front') && get_option('page_for_posts')) {
        ...
        register_template('blogTemplate', get_option('home') . '/wp-content/themes/' . get_template() . '_preview/export/no-blog-template.php', false, true);
    }
...
<?php
    ...
    register_template('event', $GLOBALS['pageTemplatesHelper']->get_sample_post('single_12.php', 'single_12.php'), true, true);
?>
<?php
...
<?php
    if (theme_woocommerce_enabled()) {
        ...
        register_template('products', get_option('home') . '/wp-content/themes/' . get_template() . '_preview/export/no-woocommerce-template.php', false, true);
    }
?>
<?php
    if (theme_woocommerce_enabled()) {
