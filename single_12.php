...
<body <?php body_class(' bootstrap bd-body-12 bd-pagebackground'); /*   */ ?>>
<div data-affix
     data-offset=""
 ...
 col-sm-6">
    <div class="bd-layoutcolumn-9 bd-column" ><div class="bd-vertical-align-wrapper"><?php theme_logo_2(); ?></div></div>
		...
		<div class="bd-containereffect-9 container "><div class=" bd-spacer-6  clearfix"></div></div>
	
		<div class="bd-contentlayout-15 bd-sheetstyles " >
    <div class="bd-container-inner">
 ...
 <?php theme_sidebar_area_5(); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class=" bd-layoutitemsbox-8 bd-flex-wide">
